 ...
 * {@link com.bnpparibas.dec.bookingconfirmation.domain.service.BookingConfirmationTradeEventAggregator} operates on.
 *
 * <p>The payload itself stays the opaque raw JSON carried by {@code message}; only the type
 * discriminator has been parsed out.
 */
public record ParsedTradeEvent(InboxMessage message, TradeEventType eventType) {

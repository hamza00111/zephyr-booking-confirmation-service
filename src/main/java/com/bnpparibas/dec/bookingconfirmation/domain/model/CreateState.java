 ...
 * rejects an AMEND/DELETE whose CREATE it never received, so an AMEND must never be relayed before its
 ...
 *   └──deleted before any CREATE emitted──► VOID
 * </pre>
 *
...
public enum CreateState {
    ...
    FAILED,
    /** The trade was deleted before any CREATE was emitted — nothing is published for it. */
    VOID
}

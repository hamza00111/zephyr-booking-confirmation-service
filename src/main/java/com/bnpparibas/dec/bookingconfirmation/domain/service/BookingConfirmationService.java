 ...
 *
 * <p>The scheduler invokes {@link #tick()} on a fixed delay. Safe concurrency across instances comes
 * from the drain's {@code FOR UPDATE SKIP LOCKED} row claiming, not an application-level lock.
 */
public interface BookingConfirmationService {
    ...
    /** One scheduled iteration of the stage's work. */
    void tick();

 ...
 * rows, distributed lock, circuit breaker, and scheduled tasks, and publishes to its own
 * {@code published.<region>} topic. A failure or backlog in one region never affects another.
 */
public enum Region {
    AMER,
    APAC,

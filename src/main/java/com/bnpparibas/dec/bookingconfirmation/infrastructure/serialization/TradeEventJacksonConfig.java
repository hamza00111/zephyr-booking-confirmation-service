...
public class TradeEventJacksonConfig {
    ...
    public static final String TRADE_EVENT_OBJECT_MAPPER = "tradeEventObjectMapper";

    @Bean(TRADE_EVENT_OBJECT_MAPPER)
    public ObjectMapper tradeEventObjectMapper() {
        return buildTradeEventMapper();
    }

    /** Static so tests can build the exact production mapper without a Spring context. */
    public static ObjectMapper buildTradeEventMapper() {
